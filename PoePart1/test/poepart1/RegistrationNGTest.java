...
public class RegistrationNGTest {
    ...
    public void testRegisterUser() {
        ...
        String cellphone = "0629820124";
        Registration instance = new Registration();
        String expResult = "Registration success";
    ...
    /**
     * Test of regitrationUser method, of class Registration.
     */
    @Test
    public void testRegitrationUser() {
        System.out.println("regitrationUser");
        String name = "";
        String password = "";
        String cellphone = "";
        Registration instance = new Registration();
        boolean expResult = false;
        boolean result = instance.regitrationUser(name, password, cellphone);
        assertEquals(result, expResult);
        // TODO review the generated test code and remove the default call to fail.
